...
public class gameView implements Observer{
	...
	private Scene constructMenu() {
		...
		load.setOnAction((e)-> {
			...
			//controller.setModel(data.getModel());
...
//			oos.close();
//			Alert information = new Alert(Alert.AlertType.INFORMATION, "Saved successfully");
...
//                GameModel preModel = (GameModel) ois.readObject();
//                controller.setModel(preModel);
//   
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
